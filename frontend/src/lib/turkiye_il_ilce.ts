// Türkiye il ve ilçe listesi (81 il)
// Kaynak: https://gist.github.com/c63063e4b40c756d4040a0be694895e9

export type IlceMap = Record<string, string[]>

export const TURKIYE_IL_ILCE: IlceMap = {
  "Adana": ["Aladağ", "Ceyhan", "Çukurova", "Feke", "İmamoğlu", "Karaisalı", "Karataş", "Kozan", "Pozantı", "Saimbeyli", "Sarıçam", "Seyhan", "Tufanbeyli", "Yumurtalık", "Yüreğir"],
  "Adıyaman": ["Adıyaman", "Besni", "Çelikhan", "Gerger", "Gölbaşı", "Kahta", "Samsat", "Sincik", "Tut"],
  "Afyonkarahisar": ["Afyonkarahisar", "Başmakçı", "Bayat", "Bolvadin", "Çay", "Çobanlar", "Dazkırı", "Dinar", "Emirdağ", "Evciler", "Hocalar", "İhsaniye", "İscehisar", "Kızılören", "Sandıklı", "Sincanlı", "Şuhut", "Sultandağı"],
...
export const TURKIYE_ILLER = Object.keys(TURKIYE_IL_ILCE).sort((a, b) =>
  a.localeCompare(b, 'tr')
)

export function ilceleriGetir(il: string): string[] {
  return TURKIYE_IL_ILCE[il] ?? []
}

export const YURTDISI_LABEL = 'Yurtdışı'
